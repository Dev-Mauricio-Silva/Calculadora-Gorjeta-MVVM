//
//  calculadora_de_gorjetaTests.swift
//  calculadora-de-gorjetaTests
//
...
import XCTest
import Combine
@testable import calculadora_de_gorjeta
...
final class calculadora_de_gorjetaTests: XCTestCase {
    ...
    func testSoundPlayedAndCalculatorResetOnLogoViewTap() {
        ...
        let output = sut.transform(input: input)
        let expectation1 = XCTestExpectation(description: "Função de reset foi chamada")
...
class MockAudioPlayerService: AudioPlayerService {
    var expectation = XCTestExpectation(description: "PlaySound foi chamado")
    func PlaySound() {
        expectation.fulfill()
    }
}
